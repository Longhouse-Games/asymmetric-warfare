  ...
  socket.on('connect', function() {
    ...
    socket.on('update', function(data) {
      ...
      if (data.state) {
        ...
        actionsview.render(role, false, board, data.state.currentPhase, data.state.currentTurn);
      } else {
        var history = _.map(data.history, function(dto) {
          return History.fromDTO(dto);
        });
        ...
        actionsview.render(role, infowar.canGrow(), infowar.getBoard(), infowar.currentPhase(), currentTurn);
        historyview.render(history);
