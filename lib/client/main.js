...
require([
  ...
  var BoardView = function() {
    ...
    return {
      ...
      render: function(pieces) {
        _.each(pieces, function(pieces_here, poskey) {
          ...
          _.each(groups[h.C.STATE], function(piece) {
            ...
            console.log("Found me a STATE piece at "+poskey);
          });
          _.each(groups[h.C.INSURGENT], function(piece) {
            $space.text($space.text() + "O");
            console.log("Found me an INSURGENT piece at "+poskey);
          });
        });
      }
    };
  ...
  socket.on('connect', function() {
    ...
    socket.on('update', function(data) {
      ...
      boardview.render(infowar.getPieces());
