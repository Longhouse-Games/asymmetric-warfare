...
require([
  ...
  var BoardView = function() {
    ...
    var displayMovablePieces = function(infowar, controllerMethod) {
      $(".space").removeClass("selectable");
      var positions = _.chain(infowar.getPieces())
          .map(function(piecesAt, poskey) {
            if (_.any(piecesAt, function(piece) { return piece.type() === infowar.currentTurn().id(); })) {
      ...
      makeSelectable(positions, function(src) {
        var adjacentPositions = _.filter(src.adjacentPositions(), function(dest) {
    ...
    var displayMovableInsurgents = function(infowar) {
      displayMovablePieces(infowar, controller.insurgentMove);
    };

    var displayMovableStatePieces = function(infowar) {
      displayMovablePieces(infowar, controller.stateMove);
    };
