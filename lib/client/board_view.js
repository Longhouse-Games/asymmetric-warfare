define(['underscore', 'allong.es', 'lib/constants', 'lib/position', 'lib/insurgent_move', 'lib/state_move'],
  ...
  var BoardView = function() {
    ...
    var displayMovablePieces = function(Move, board, role, currentTurn, remainingMovementPoints, controllerMethod) {
      clearSelected();
    ...
    var displayMovableStatePieces = function(board, role, currentTurn, remainingMovementPoints) {
      displayMovablePieces(StateMove, board, role, currentTurn, remainingMovementPoints, controller.stateMove);
    };
