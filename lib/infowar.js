define(['underscore', 'lib/helpers'], function(_, h) {
  ...
  var Infowar = function() {
    ...
    var canGrow = function() {
      ...
      return (insurgentsInPlay + killedInsurgents) < h.C.MAX_INSURGENTS;
    };
    ...
    return {
      ...
      state: function(role) {
        ...
        return {
          ...
          remainingMovementPoints: currentTurn ? (currentTurn.id() === h.C.STATE ? currentTurn.movementPoints() : null) : null // TODO Clean this up
        };
      }
    };
  };
